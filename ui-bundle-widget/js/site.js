!(function () {
  ...
  var e,
    ...
    s =
      ...
      i && i.querySelector("[data-panel=menu]"));
  function t() {
    var e,
      t,
    ...
    if (
      ...
      !(e = s.querySelector('.nav-link[href="' + n + '"]')))
    ) {
  ...
  function n() {
    ...
    this.classList.toggle("is-active") &&
      ...
      0 < (i = (t.bottom - n.top - n.height + e).toFixed()) &&
        (s.scrollTop += Math.min((t.top - n.top - e).toFixed(), i)));
  }
  function l(e) {
    d(e);
  ...
  s &&
    ...
    u(s, ".nav-item-toggle").forEach(function (e) {
      ...
      e &&
        ((e.style.cursor = "pointer"), e.addEventListener("click", n.bind(t)));
    }),
    e &&
...
!(function () {
  ...
  if (e) {
    ...
    if (!(l < 0)) {
      for (
        var u = "article.doc", f = document.querySelector(u), m = [], t = 0;
        t <= l;
        t++
      ) {
        var n = [u];
      ...
      var a = {},
        ...
        r =
          (i || ((i = document.createElement("div")).className = "toc-menu"),
        ...
        e =
          ...
          !document.getElementById("toc") &&
            f.querySelector("h1.page ~ :not(.is-before-toc)"));
      e &&
  ...
  function p() {
    ...
    if (
      e &&
      window.innerHeight + e + 2 >= document.documentElement.scrollHeight
    )
      return (
        ...
        ? t !== d &&
          ...
          s.scrollHeight > s.offsetHeight &&
            (s.scrollTop = Math.max(
              0,
              e.offsetTop + e.offsetHeight - s.offsetHeight
            )),
          (d = t))
  ...
  !document.documentMode ||
    ...
    window.addEventListener("load", function e(t) {
      ...
      (n = i(window.location.hash)) &&
        ...
        (c.bind(o)(), setTimeout(c.bind(o), 0)),
    ...
    Array.prototype.slice
      ...
      .forEach(function (e) {
        ...
        (t = i(e.hash)) &&
          ...
          e.addEventListener("click", c.bind(n));
      }));
})();
!(function () {
  "use strict";
          ...
          "svg" === r
            ? ((a = document.createElementNS(
              ...
              (c = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "use"
              )).setAttribute("href", d + "/img/octicons-16.svg#icon-clippy"),
              a.appendChild(c),
              n.appendChild(a))
            : (((c = document.createElement("img")).src =
                d + "/img/octicons-16.svg#view-clippy"),
              (c.alt = "copy icon"),
