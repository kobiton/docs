...
^*2*^ _iOS 12 and 13 support is re-integrated since 4.19 release with some xref:release-notes:all-releases/4_19.adoc#_reintegrate_ios_12_and_13_support[known limitations]._
