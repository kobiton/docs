...
|Google
|Android
|link:https://developer.android.com/about/versions/oreo[Android 8,window=read-later] through link:https://developer.android.com/about/versions/17[Android 17,window=read-later] ^*1*^
