...
For a complete list of supported gestures, see xref:screen-reader/screen-reader-gestures.adoc[VoiceOver gestures and shortcuts,window=read-later].
...
image:voiceover-timeline.png[width=1000,alt="Session timeline showing recorded VoiceOver gestures and screen reader accessibility events"]