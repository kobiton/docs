...
For a complete list of supported shortcuts, see xref:screen-reader/screen-reader-gestures.adoc[TalkBack gestures and shortcuts,window=read-later].
...
image:talkback-timeline.png[width=1000,alt="Session timeline showing recorded TalkBack gestures and screen reader accessibility events"]
