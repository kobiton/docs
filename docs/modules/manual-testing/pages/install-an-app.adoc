...
image:install-apps-context.png[width=1000,alt="A manual test session with the "Install Apps" button highlighted"]
...
image:manual-testing:install-apps-closeup.png[width=500, alt="A close-up of the different app installation options during a manual session."]

You'll be notified when your installation is finished.

image:manual-testing:install-apps-closeup2.png[width=500, alt="A close-up of the installation finished" notification"]
