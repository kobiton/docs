...
Once our xref:apps:biometric-authentication/about-biometrics-authentication.adoc[biometrics authentication library] is added to your app, select *Biometric Authentication*, then choose *Pass* or *Fail* to test authentication requests.
