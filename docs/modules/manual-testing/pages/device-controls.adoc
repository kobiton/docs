...
image:manual-testing:media-injection.png[width=500, alt="The media injection button in a manual session."]
...
[IMPORTANT]
====
Follow xref:manual-testing:local-devices/inject-audio.adoc[this guide] for more details on how to use image injection.
====
...
image:manual-testing:audio-injection-closeup.png[width=500, alt="A manual session with a closeup of audio injection."]
...
image:manual-testing:audio-injection-disabled.png[width=500, alt="A message indicating that audio injection is not enabled on the device."]
