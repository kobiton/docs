...
To input sensitive data (like usernames and passcodes) without it being recorded in the xref:session-explorer:manage-sessions.adoc#_watch_the_recording[session video], select *Input Sensitive Data*, then enter the data in the text box.
