...
Once xref:devices:local-devices/configure-ios-voiceover.adoc[VoiceOver for iOS] is set up, select *Perform VoiceOver*, then choose a VoiceOver option to test an app's screen reader compatibility.
