...
[NOTE]
If you were using a public device, you'll be charged testing minutes during idle time. You can change your default idle time, in xref:profile:manage-your-profile.adoc#_change_your_session_timeout[your profile].
