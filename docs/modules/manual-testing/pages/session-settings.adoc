...
image:manual-testing:manual-session-settings.jpg[width=, alt="A manual session with the session settings options in the middle of the page."]

== Settings

=== Name

image:edit-name-in-manual-setting.jpg[width=, alt="A close-up of the name field."]
...
image:manual-testing:description-field.jpg[width=, alt="A close-up of the description field."]
...
image:manual-testing:session-timeout-unchecked.jpg[width=, alt="A close-up of the idle settings."]
...
image:manual-testing:cleanup-policies-checked.jpg[width=, alt="A close-up of the clean-up settings."]
