...
After you xref:devices:local-devices/configure-ios-voiceover.adoc[enable iOS VoiceOver] you can xref:manual-testing:device-controls.adoc#_adb_shell[run iOS VoiceOVer commands] during a manual session to test your app's screen reader compatibility.

image:manual-testing:perform-voiceover-context.png[width=1000,alt="A context to Perform voiceover feature"]
