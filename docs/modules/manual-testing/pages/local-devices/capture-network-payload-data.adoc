...
Learn how to capture network payload data during a manual session so you can xref:session-explorer:session-explorer-tools/review-network-payload-data.adoc[review network payload data] in Session Explorer.
