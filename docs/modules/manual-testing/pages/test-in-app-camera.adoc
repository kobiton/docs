...
image::manual-testing:image-injection.jpg[alt="A device with image injection opened during a manual test session]
...
image::manual-testing:zoom image injection.jpg[alt="A close-up of the image injection library containing two images."]
