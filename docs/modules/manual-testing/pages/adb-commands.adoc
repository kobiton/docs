...
During a manual session, you can xref:device-controls.adoc#_adb_shell[run Android Debug Bridge (`adb`) commands] on public devices, as well as private and local ones.
