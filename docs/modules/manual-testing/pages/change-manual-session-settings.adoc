...
To disable the device's cleanup policy for the current session, uncheck the box. For more information, see xref:devices:local-devices/cleanup-policy/manage-device-cleanup-policies.adoc[Device cleanup policies].
