...
* xref:manual-testing:start-a-virtual-session.adoc[]
...
** xref:manual-testing:local-devices/appleid-2FA.adoc[]
...
** xref:manual-testing:screen-reader/talkback-manual-session.adoc[]
...
* xref:manual-testing:simulate-shake-gesture-ios.adoc[]
