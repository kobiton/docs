...
image:scriptless-automation:ignore-remediation.png[width=1000,alt="Ignore Remediation"]
...
image:scriptless-automation:ui-remediation.png[width=1000,alt="UI Remediation"]
