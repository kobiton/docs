...
* Get the related session ID(s) using the xref:get-a-session-id/using-the-kobiton-portal.adoc[Kobiton portal] or xref:get-a-session-id/using-the-kobiton-api.adoc[Kobiton API].
