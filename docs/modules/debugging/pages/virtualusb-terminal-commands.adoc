= virtualUSB terminal commands
:navtitle: virtualUSB terminal commands
...
[NOTE]
The alternate method will expose your password in the terminal. Do not use this method if you're sharing your screen or around others.
