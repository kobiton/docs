...
* To debug on a Kobiton Standalone server, get xref:debugging:local-devices/configure-standalone-server.adoc#_get_server_information_for_your_team[server information] from your system administrator.
