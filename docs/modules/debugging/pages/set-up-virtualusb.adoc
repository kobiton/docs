...
[IMPORTANT]
xref:debugging:local-devices/configure-your-personal-computer.adoc[Configure your computer for Standalone Portal with a self-signed SSL certificate] before signing in.
