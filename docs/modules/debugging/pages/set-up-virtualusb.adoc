...
Learn how to set up virtualUSB on your personal computer, so you can debug public and private devices. If you want to debug _local_ devices instead, after your initial set up, you'll also need to xref:debugging:debug-local-devices/configure-personal-computer.adoc[configure your personal computer for debugging local devices].
...
Now you can debug cloud devices using virtualUSB. If you plan on debugging _local_ devices using virtualUSB, you'll need to xref:debugging:debug-local-devices/configure-personal-computer.adoc[configure your personal computer for debugging local devices].
