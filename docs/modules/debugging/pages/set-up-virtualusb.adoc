...
For Windows, link:https://support.apple.com/HT210384[install iTunes]. Also, consider installing a third-party library that lets your Windows computer communicate with iOS devices natively.
...
Finally, launch virtualUSB and sign in using your email address and passcode or xref:profile:your-api-keys.adoc[Kobiton API key].
