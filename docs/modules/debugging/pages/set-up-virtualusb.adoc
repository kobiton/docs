...
Learn how to set up virtualUSB on your personal computer so you can debug *public* and *private* devices. If you also want to debug *local* devices, xref:debugging:local-devices/configure-your-personal-computer.adoc[configure your personal computer] after the initial setup.
