...
image:launch-vu-context.png[width=1000,alt="A context to launching virtualUSB"]

Search for a device.

image:search-devices-vu-context.png[width=1000,alt="A context to search for a device"]

Select *Connect* to start a debug session using the selected device.

image:connect-device-context.png[width=1000,alt="A context to connect a device"]
