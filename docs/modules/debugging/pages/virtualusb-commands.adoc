...
* If you're debugging on a local Kobiton server, xref:debugging:debug-local-devices/configure-personal-computer.adoc[configure your personal computer for debugging local devices].
...
Log in to your Kobiton account using your email address and password or xref:profile:server-url-and-api-keys.adoc[Kobiton API key].
...
Alternatively, specify your username and password in the `login` command:
