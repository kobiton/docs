...
In *Devices*, view device metadata in the xref:device-settings.adoc[device settings] or use device metadata to create xref:search-for-a-device.adoc#_custom_columns[custom columns].
