...
image:view-device-metadata-closeup.png[width=500,alt="Click the vertical ellipse to view the device metadata"]

== Device Name (default)

image:device-metadata-closeup.png[width=500,alt="View the Device Metadata"]
