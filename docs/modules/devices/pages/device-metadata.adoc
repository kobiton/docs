...
image:automation-testing:view-device-metadata-closeup.png[width=500,alt="Click the vertical ellipse to view the device metadata"]

== Device Name (default)

image:automation-testing:device-metadata-closeup.png[width=500,alt="View the Device Metadata"]
...
The device tag xref:manage-devices.adoc#_add_or_remove_tags[assigned to the device]. For example,
