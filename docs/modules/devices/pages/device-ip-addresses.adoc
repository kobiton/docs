...
These are the IP address for Kobiton devices. You can use a device IP address to xref:local-devices/connect-to-your-private-network.adoc[connect devices to your private network].
