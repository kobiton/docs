...
image:devices:network-payload-capture-context.png[width=1000,alt="Select "Network Payload Capture"]

Enter one or more domain names, then select *Advanced*.

image:devices:highlight-advanced-link-context.png[width=1000,alt="Select Advanced"]

Choose one or more xref:devices:local-devices/network-payload-capture/supported-mime-types.adoc[MIME types] to capture.

image:devices:select-advanced-closeup.png[width=500,alt="Select Advanced in Network Payload Capture modal"]
