...
== (iOS only) Option 1: Check the supervision identity and dc.ini configuration
...
== (iOS only) Option 2: Establish trusted ssh connection and install Automation Tools
