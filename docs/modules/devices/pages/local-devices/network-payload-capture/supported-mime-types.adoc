...
These are the supported MIME types for configuring network payload capture for xref:local-devices/network-payload-capture/configure-ios-device.adoc[iOS] and xref:local-devices/network-payload-capture/configure-android-device.adoc[Android] devices.
