...
Network payload captures lets you and your team capture network payload data during xref:manual-testing:local-devices/capture-network-payload-data.adoc[manual sessions] and xref:automation-testing:local-devices/capture-network-payload-data.adoc[automation sessions]. After you complete your session, launch xref:session-explorer:launch-session-explorer.adoc[Session Explorer] to view your data.

image:npc-in-session-explorer-context.png[width=1000,alt="A display of Network Payload Capture in Session Explorer after a manual session"]
