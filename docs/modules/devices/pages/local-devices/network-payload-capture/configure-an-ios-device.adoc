...
The process mentioned in this section should only be done once. Skip this process if your organization already has a supervision identity.

To check if there is already a supervision identity available:
