...
If the payment is confirmed, you have successfully verified that bypassing Apple Pay double click works. Proceed to the next guide: xref:devices:local-devices/use-apple-pay/use-apple-pay-in-manual-session.adoc[]
