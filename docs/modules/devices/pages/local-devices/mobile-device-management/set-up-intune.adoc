...
image:intune-device-list-ios.png[] image:intune-device-list-android.png[]
...
image:intune-app-store-ios.png[]
...
image:intune-install-management-profile.png[]

Go back to the Home screen and navigate to Settings and select Profile Downloaded:

image:intune-settings-profile-downloaded.png[]
...
image:intune-passcode-enter.png[]
...
image:intune-play-store-android.png[]
