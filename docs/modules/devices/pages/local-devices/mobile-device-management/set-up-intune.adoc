...
image:intune-default-org-no-cleanup.png[width=800,alt="The No Cleanup policy selected in the Cleanup Policies list with the button Mark as Default visible"]

Click *OK* in the pop-up to confirm the action:

image:intune-cleanup-mark-as-default.png[width=300,alt="The Mark as Default pop-up with the OK button visible"]
...
image:intune-teams-list.png[width=800,alt="The Intune team visible in the Teams list under the Organization menu that can be selected for editing"]

Navigate to the *Settings* tab and make sure *No Cleanup* is selected under *Cleanup Policy*. Click Save to apply the changes.

image:intune-team-edit.png[width=600,alt="The Cleanup Policy drop-down list with No Cleanup selected under Team Settings"]
...
Log into the Kobiton Portal and select *Devices* in the navigation. Click the *Launch* icon on an iOS or Android device:

image:intune-device-list-ios.png[width=800,alt="The Launch button under an iOS device in the Private or local devices list"] image:intune-device-list-android.png[width=800,alt="The Launch button under an Android device in the Private or local devices list"]

In the Manual Session, open the *App Store* (iOS) or *Google Play Store* (Android) and log in using an Apple or Google account.

Search for and install the *Intune Company Portal* app:

image:intune-app-store-ios.png[width=240,alt="The Intune Company Portal app with the Get button visible in Apple App Store"] image:intune-play-store-android.png[width=240,alt="The Intune Company Portal app with the Install button visible in Google Play Store"]

When the installation is complete, launch the app. Sign in using the organization’s Microsoft account:

image:intune-sign-in.png[width=240,alt="The start screen of the Intune Company Portal app with the sign in button"]
...
image:intune-device-list-ios.png[width=800,alt="The Launch button under an iOS device in the Private or local devices list"]
...
image:intune-app-store-ios.png[width=240,alt="The Intune Company Portal app with the Get button visible in Apple App Store"]
...
image:intune-install-management-profile.png[width=240,alt="The instructions to install management profile in the enrollment process in Intune Company Portal"]

Go back to the Home screen and navigate to Settings and select Profile Downloaded:

image:intune-settings-profile-downloaded.png[width=240,alt="The Profile Downloaded option in the Settings app"]
...
image:intune-passcode-enter.png[width=240,alt="The passcode input screen"]
...
image:intune-passcode-confirm.png[width=240,alt="The passcode confirmation screen with the Done button visible"]

Continue with the setup process.

After Intune verifies that the device is now compliant, the below screen will appear:

image:intune-ios-enroll-complete.png[width=240,alt="The enrollment complete screen with the You're all set message"]
...
image:intune-device-list-android.png[width=800,alt="The Launch button under an Android device in the Private or local devices list"]

System sets a random PIN as passcode on the device.

In the Manual Session, open the Play Store and log in using a Google account.

Search for and install the Intune Company Portal app.

image:intune-play-store-android.png[width=240,alt="The Intune Company Portal app with the Install button visible in Google Play Store"]
...
image:intune-android-enroll-complete.png[width=240,alt="The enrollment complete screen with the You're all set message"]

Open the *Settings* app and tap *Lock screen*. Make sure the Use one lock setting under *Work profile security* is enabled.

image:intune-settings-lock-screen.png[width=240,alt="The Lock screen option in the Settings app"] -> image:intune-use-one-lock-lock-screen.png[width=240,alt="The Use one lock switch turned on under Work profile security in the Lock screen page"]

On some devices, tap *Work profile* instead of Lock screen. Make sure the Use one lock setting under *Work profile* is enabled.

image:intune-settings-work-profile.png[width=240,alt="The Work profile option in the Settings app"] -> image:intune-use-one-lock-work-profile.png[width=240,alt="The Use one lock switch turned on in the Work profile screen"]
