...
* Configurations _not_ marked with ^*^*^ can be selected/deselected in the _Create_ or _Edit cleanup policy_ dialog.
...
* Supports exemption of apps with specified package name (supports wildcard character \*). Separate entries with command or space. _Example:_ com.sample.app, com.myCompany.*

image:devices:cleanup-policy-remove-apps.png[width=800,alt="The All apps installed within a session will be removed option with field to specify exempted apps"]
...
* * Supports exemption of apps with specified bundle ID (supports wildcard character \*). Separate entries with command or space. _Example:_ com.sample.app, com.myCompany.*
