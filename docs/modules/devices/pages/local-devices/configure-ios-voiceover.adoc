...
Learn how to configure iOS VoiceOver so you can run xref:manual-testing:device-controls.adoc#_perform_voiceover[iOS VoiceOver commands] to test your app's screen reader compatibility during your test session.
...
Now you can run xref:manual-testing:device-controls.adoc#_perform_voiceover[iOS VoiceOver commands] during a manual test session.
