...
To prevent other users from accessing the device during a test session, select *Retain*, then choose a duration: *1 hour, 2 hours, 4 hours, 8 hours, 24 hours, or Unlimited*.

[NOTE]
Organization admins can control whether xref:organization:other-settings.adoc#_device_retention[the Unlimited option,window=read-later] is available for device retention.
