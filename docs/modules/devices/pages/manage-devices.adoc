...
Once xref:devices:local-devices/network-payload-capture/network-payload-capture.adoc[network payload capture] is configured, select *Use Configuration* and choose a configuration.
