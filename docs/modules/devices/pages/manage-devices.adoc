...
[NOTE]
Only Admins can manage device passcodes.

To require a passcode for this device, enable *Passcode Feature Enforced*, then enter a passcode. For more information, see xref:devices:about-device-passcodes.adoc[].
