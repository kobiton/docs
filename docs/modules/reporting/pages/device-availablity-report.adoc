...
image:device-availability-report-context.png[width=400,alt="Device Availability report in Predefined report"]
...
image:private-devices-report-context 1.png[width=1000,alt="Private devices in the report"]
