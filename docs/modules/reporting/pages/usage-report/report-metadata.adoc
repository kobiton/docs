...
xref:session-explorer:session-explorer-tools/fix-accessability-issues.adoc[Font size validation] in the Session Explorer.

=== Accessibility Validation

xref:session-explorer:session-explorer-tools/fix-accessability-issues.adoc[Accessibility validation] in the Session Explorer.
