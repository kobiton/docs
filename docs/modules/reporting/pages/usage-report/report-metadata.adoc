...
xref:session-explorer:session-explorer-tools/fix-accessability-issues.adoc[Font size validation] in Session Explorer.

=== Accessibility Validation

xref:session-explorer:session-explorer-tools/fix-accessability-issues.adoc[Accessibility validation] in Session Explorer.
