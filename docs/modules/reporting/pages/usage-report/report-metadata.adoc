...
xref:session-explorer:validations/validate-accessability.adoc[Font size validation] in Session Explorer.

=== Accessibility Validation

xref:session-explorer:validations/validate-accessability.adoc[Accessibility validation] in Session Explorer.
