...
xref:session-explorer:tools/accessability-validation.adoc[Font size validation] in the Session Explorer.

=== Accessibility Validation

xref:session-explorer:tools/accessability-validation.adoc[Accessibility validation] in the Session Explorer.
