...
xref:session-explorer:validations/validate-user-accessability.adoc[Font size validation] in Session Explorer.

=== Accessibility Validation

xref:session-explorer:validations/validate-user-accessability.adoc[Accessibility validation] in Session Explorer.
