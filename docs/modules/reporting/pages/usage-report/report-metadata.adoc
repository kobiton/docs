...
The usage report measures component usage across all user test sessions. Reference this metadata when you xref:reporting:usage-report/manage-the-report.adoc[manage your report].
