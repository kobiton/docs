...
The system latency report lists each test session and the amount of time it took the system to preform an action during the session. Reference this metadata when you xref:reporting:system-latency-report/manage-the-report.adoc[manage your report].
