...
Learn how to manage the system latency report so you can view how long it takes the system to perform an action. See xref:system-latency-report/report-metadata.adoc[report metadata] to learn more about each field and data type in the report.
...
Select the session ID to open the xref:session-explorer:manage-a-session.adoc[session overview] and review the session.
