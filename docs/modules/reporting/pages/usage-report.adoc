...
xref:scriptless-automation:remediation/text-validation.adoc[Text validation] within a Scriptless session.

=== Color Validation

xref:scriptless-automation:remediation/color-text-validation.adoc[Color text validation] within a Scriptless session.
