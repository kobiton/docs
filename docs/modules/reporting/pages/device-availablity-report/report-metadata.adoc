...
The device availability report is a collection of predefined reports containing all outage entries for your private and local devices. Reference this metadata when you xref:device-availablity-report/manage-the-report.adoc[manage your report].
