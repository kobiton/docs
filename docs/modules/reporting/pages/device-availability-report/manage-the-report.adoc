...
Learn how to manage the device availability report so you can view availability data for your devices. See xref:device-availability-report/report-metadata.adoc[report metadata], to learn more about each field and data type in the report.
