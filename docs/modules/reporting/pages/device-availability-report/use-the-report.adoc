...
image:select-report-context.png[width=1000,alt="A context to the Reports feature selected"]
...
image:search-udid-closeup.png[width=1000,alt="A closeup to enter the UDID to search"]
...
image:select-pencils-closeup.png[width=1000,alt="Select the pencil icon"]

To exclude this outage from your SLA, check the box.

image:exclude-sla-closeup.png[width=500,alt="Check the exclude from SLA Calculation"]
