...
Learn how to manage the device summary report so you can view a general summary for all your devices. See xref:device-summary-report/report-metadata.adoc[report metadata], to learn more about each field and data type in the report.
