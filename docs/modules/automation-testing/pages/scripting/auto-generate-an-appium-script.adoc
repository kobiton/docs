...
Appium scripts are automatically generated after every _successful_ manual session. Before you start, check if your session xref:test-management:remediation/index.adoc[requires remediation].
