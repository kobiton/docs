...
Appium scripts are automatically generated after every _successful_ manual session. Before you start, check if your session xref:scriptless-automation:remediations/index.adoc[requires remediation].
...
Next, select the *Export Appium Script* icon. If you don't see an icon, check if your session xref:scriptless-automation:remediations/index.adoc[requires remediation].
