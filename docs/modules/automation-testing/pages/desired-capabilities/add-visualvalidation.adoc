...
When you're finished, save your changes. Now you can use `visualValidation` to test a single device. To test devices in parallel, also xref:_modify_setup_function[modify your `setup()` function].
