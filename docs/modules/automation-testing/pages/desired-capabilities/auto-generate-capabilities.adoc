...
Now choose your capabilities. When you do, your `DesiredCapabilities` object will update automatically. To learn more about a capability, see xref:desired-capabilities/available-capabilities.adoc[].

Here's an example `DesiredCapabilities` object:
