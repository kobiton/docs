...
Now choose your capabilities. When you do, your `DesiredCapabilities` object will update automatically. To learn more about a capability, see xref:automation-testing:desired-capabilities/available-capabilities.adoc[].
