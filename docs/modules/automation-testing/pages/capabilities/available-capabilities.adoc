...
* <<_accessibilityValidation,kobiton:accessibilityValidation>>
...
* <<_scriptlessCapture,kobiton:scriptlessCapture>>
...
[#_accessibilityValidation]
=== `kobiton:accessibilityValidation`

Runs accessibility validation during an Appium automation session. See xref:automation-testing:scripting/add-accessibility-validation-to-appium-script.adoc[] for setup.

* *Type:* `boolean`
* *Required capabilities:* xref:_scriptlessCapture[`kobiton:scriptlessCapture`] set to `true`
...
[#_scriptlessCapture]
=== `kobiton:scriptlessCapture`

Captures full session data during an Appium automation session. Required when running xref:_accessibilityValidation[`kobiton:accessibilityValidation`].
