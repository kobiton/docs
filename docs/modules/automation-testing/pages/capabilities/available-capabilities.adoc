...
These capabilities are unique to Kobiton. To use these in Basic Appium 2 script, add the `'kobiton:'` before the capability. Example: `'kobiton:sessionName'`

[NOTE]
Not all Kobiton capabilities can be used in Basic Appium 2 script. Refer to individual capability for details.
...
Kobiton supports standard Appium capabilities.
