...
Search every available web context during an Appium find call. For more information, see xref:automation-testing:capabilities/add-web-find.adoc[window=read-later].
