...
Enables Bluetooth functionality on the device during the session. Required for xref:automation-testing:scripting/add-audio-injection-to-appium-script.adoc[audio injection in automated sessions,window=read-later].
