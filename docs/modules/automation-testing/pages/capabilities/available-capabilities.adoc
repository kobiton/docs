...
Remove all apps installed during the test session. To keep the apps and only remove their data, use xref:_noreset[].
...
Remove application data but keep the installed app. To completely remove the app, use xref:_fullreset[].
