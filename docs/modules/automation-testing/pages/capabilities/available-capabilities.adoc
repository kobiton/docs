...
=== `kobiton:ensureWebviewsHavePages`
...
Kobiton supports most Appium capabilities. The below capabilities are either usually required, well-known, or have an impact to Kobiton system.
