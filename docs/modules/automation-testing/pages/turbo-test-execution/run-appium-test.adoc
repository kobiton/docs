...
** xref:profile:manage-your-profile.adoc#_retrieve_your_username_and_email[Username or email,window=read-later]
...
* `<session_id>` is obtained from the response of the <<Check status for queued execution mode,check queue status>> request.
