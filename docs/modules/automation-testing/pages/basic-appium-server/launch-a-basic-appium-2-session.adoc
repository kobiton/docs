...
* AI features - including Scriptless, generate Appium script, validations, and xref:automation-testing:capabilities/add-flexcorrect.adoc[flexCorrect] - are not supported for basic Appium 2 sessions as they rely heavily on exhaust.
