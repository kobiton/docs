= Launch a basic Appium 2.0 session on Kobiton 4+ [Beta]
:navtitle: Launch a basic Appium 2.0 session [Beta]
...
Note that basic Appium 2.0 support is an beta release, so it currently has several limitations that will be considered for future releases.
