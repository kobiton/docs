...
Appium AI evaluates the description and returns the most relevant matching element, using either metadata from the view hierarchy or vision-based analysis of a screenshot, depending on what the application exposes.
...
* For metadata-based resolution, confirm that the application exposes sufficient UI metadata (view hierarchy or accessibility attributes) for element identification

* For vision-based resolution, ensure the target element is clearly visible on the current screen
