...
Learn how to capture network payload data during an automation session so you can review request and response data in xref:session-analytics:about-the-session-explorer.adoc[Session Explorer].
