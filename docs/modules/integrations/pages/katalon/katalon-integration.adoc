...
* A *Kobiton account*. Get the following information from your Kobiton account in the Portal:
...
Open *Katalon Studio* and log in to your Katalon Enterprise account.

Open an existing project or create a new one from the *Mobile* sample projects (see the sample project below).

image:katalon-settings-create-new-project.png[width=661px,alt="Creating a new mobile test project in Katalon with Kobiton sample project template."]
...
** From the menu bar, select *Window → Katalon Studio Preferences*.
+
image:katalon-preferences-access-linux-ubuntu.png[width=600,alt="Katalon Studio Window menu on Ubuntu Linux highlighting the Katalon Studio Preferences option."]
...
* Kobiton Server.
include::integrations:partial$appium-server-url.adoc[]
* Username
* API Key
...
+
image:katalon-test-case-start-application-default-value.png[width=658px,alt="The default value of the Start Application step in the test case before editing."]
...
image:katalon-test-case-default-view.png[width=665px,alt="Default view of a test case in Katalon."]

Switch to the *Script view*.

image:katalon-test-case-script-view.png[width=800px,alt="Script view of a test case in Katalon."]
