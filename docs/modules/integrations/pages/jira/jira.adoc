...
image:$NEEDSIMAGE$[width=,alt="A closeup image of the integrations page with Jira highlighted."]
...
image:$NEEDSIMAGE$[width=,alt="A closeup image of the Jira account connection form."]
