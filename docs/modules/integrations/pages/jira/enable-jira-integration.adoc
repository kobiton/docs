...
Enter your Jira Host URL, email, and the xref:_create_jira_api_token[API Token] you created earlier, then select *Connect* to finish. Now users in your organization can create Jira tickets directly from xref:session-explorer:manage-sessions.adoc#_create_a_jira_ticket[Session Explorer].
