...
image:$NEEDSIMAGE$[width=,alt="A closeup image of the integrations page with Figma highlighted."]
...
image:$NEEDSIMAGE$[width=,alt="A closeup image of the Figma account connection form."]
