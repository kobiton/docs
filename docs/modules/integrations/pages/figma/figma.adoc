...
Learn how to enable Figma so you can use the xref:session-explorer:session-explorer-tools/fix-ui-inconsistencies.adoc[session explorer] to flag inconsistencies between your app's Figma wireframe and final design.
...
Enter your Figma file URL and the xref:_create_figma_api_token[API key] you created earlier, then select *Connect* to finish. Now you can use the xref:session-explorer:session-explorer-tools/fix-ui-inconsistencies.adoc[session explorer] to flag inconsistencies between your app's Figma wireframe and final design.
