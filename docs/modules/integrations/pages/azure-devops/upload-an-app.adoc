...
image:azure-select-pipelines-context.png[width=1000,alt="select Pipelines in Azure DevOps"]

Select your release pipeline.

image:azure-select-your-release-context.png[width=1000,alt="Select your release pipeline"]

image:azure-select-your-pipelines-context.png[width=1000,alt="Select your pipeline"]
...
image:azure-select-pipelines-context.png[width=1000,alt="Select Pipelines on Azure"]

Select your release pipeline.

image:azure-select-your-pipelines-context.png[width=1000,alt="Select your pipeline on Azure"]
