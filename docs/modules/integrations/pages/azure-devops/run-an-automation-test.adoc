...
image:azure-select-your-release-context.png[width=1000,alt="Select your release pipeline"]

Select *Edit*.

image:azure-select-edit-context.png[width=1000,alt="Select Edit on New release pipelines"]
...
image:azure-select-kobiton-automation-test-executor-context.png[width=1000,alt="Select Kobiton Automation Test Executor"]
