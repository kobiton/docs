...
:navtitle: Run an automation test testing extension
...
* Kobiton executor server credentials: The Kobiton Executor Server credentials in the service connection store. Please mailto:support@kobiton.com[contact support] for the necessary *username, password, and domain*.
...
For Kobiton Executor Server credentials, Please mailto:support@kobiton.com[contact support].

image:integrations:add-info.png[width=1000,alt="Add information"]
...
+
image:integrations:access-azure-devops.png[width=1000,alt="Access Azure DevOps"]
...
+
image:integrations:terminate-release-pipeline.png[width=1000,alt="Terminate the release pipeline"]
