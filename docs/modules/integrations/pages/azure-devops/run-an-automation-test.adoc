...
Switch to the *Tasks* pane of the stage, then add a task to Agent job.
...
Select the stage with the Kobiton Automation Test Executor task, then select *Deploy*.

image:$NEW$[width="",alt=""]

Wait for the deployment to complete and view the logs.
