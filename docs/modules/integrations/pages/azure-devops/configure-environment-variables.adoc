...
Search for _Kobiton_, then create a connection for xref:_for_your_api_credentials[Kobiton API] and xref:_for_your_executor_server_credentials[Kobiton Server Executor].

image:$NEW$[width="",alt=""]

[#_for_your_api_credentials]
...
[#_for_your_executor_server_credentials]
