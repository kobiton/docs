= Upload your project to a cloud repository
:navtitle: Upload your project to a cloud repository
:tabs-sync-option:

Learn how to upload your project files to a cloud repository (like link:https://github.com/about[GitHub] or link:https://about.gitlab.com/[GitLab]), so you can automatically run Jenkins jobs when a commit is pushed to your project. If your project is already uploaded to a cloud repository, you can xref:integrations:jenkins/create-a-jenkins-job.adoc[create a Jenkins job].
