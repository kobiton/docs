...
* An link:https://www.deque.com/axe/devtools/mobile-accessibility/[axe DevTools for Mobile] subscription is required.
...
Session details, video, logs, and other Kobiton artifacts are available in xref:session-explorer:[Session Explorer,window=read-later].
