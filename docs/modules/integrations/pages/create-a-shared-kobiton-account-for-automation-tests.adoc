...
image:join-via-email-closeup.png[width=500,alt="A user click join the kobiton org via email"]

Enter a username, first and last name, and password for your shared Kobiton account.

image:enter-new-acc-info-closeup.png[width=400,alt="Enter a username, first and last name, and password for your shared Kobiton account"]
