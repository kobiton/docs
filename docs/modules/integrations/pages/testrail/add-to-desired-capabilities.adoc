...
In the config file, assign your Kobiton xref:profile:profile-settings.adoc[username] and xref:profile:server-url-and-api-keys.adoc[API key] to constant variables. Here's an example:
