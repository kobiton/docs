...
Below your Kobiton credentials, assign your TestRail xref:integrations:testrail/locate-credentials.adoc#_server_address[server address], xref:integrations:testrail/locate-credentials.adoc#_username[username], and xref:integrations:testrail/locate-credentials.adoc#_api_key[API key] to constant variables.
