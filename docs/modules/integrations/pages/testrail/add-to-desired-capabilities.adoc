...
When you're finished, save your changes. Now future automation sessions using this config will automatically update this TestRail project and display the project IDs in the xref:session-explorer:manage-a-session.adoc[session overview].
