...
In the config file, assign your Kobiton xref:profile:manage-your-profile.adoc#_change_your_default_team[username] and xref:profile:manage-your-api-keys.adoc[API key] to constant variables. Here's an example:
...
Below your Kobiton credentials, assign your TestRail xref:integrations:testrail/locate-credentials.adoc#_server_address[server address], xref:integrations:testrail/locate-credentials.adoc#_username[username], and xref:integrations:testrail/locate-credentials.adoc#_api_key[API key] to constant variables. Here's an example:
...
| Assign to your TestRail project's xref:integrations:testrail/locate-credentials.adoc#_run_id[run ID].

| `"kobiton:externalCaseId"`
| Assign to your TestRail project's xref:integrations:testrail/locate-credentials.adoc#_case_id[case ID].
|===
