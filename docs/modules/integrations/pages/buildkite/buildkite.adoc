...
image:app-configuration.png[width=1000,alt="App configuration"]

Once you're done adding the plugin to your pipeline, click on "Save and Build", then click "Create Build" to proceed.

image:new-build.png[width=1000,alt="The New Build window"]

image:kobiton-app-upload.png[width=1000,alt="Kobiton App Upload"]
...
image:test-execution-config.png[width=1000,alt="Test execution configuration"]
