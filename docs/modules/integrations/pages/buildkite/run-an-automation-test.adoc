...
* *Kobiton API key:* get key values from your list of xref:profile:manage-your-api-keys.adoc[Kobiton API keys].
* *Executor server credentials:* N/A
* *Cloud repository credentials:* get the URL and SSH key for the xref:integrations:buildkite/upload-a-project.adoc[project you uploaded].
...
image:buildkite-select-create-build-context.png[width=1000,alt="Select Create Build"]
