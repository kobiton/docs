...
* logo URL
+
image::organization-management:custom-org-closeup7.png[width=500,alt="options for UI visuals customization"]
...
+
image::organization-management:custom-org-closeup5.png[width=500,alt="enable-disable toolbars on iframe"]
