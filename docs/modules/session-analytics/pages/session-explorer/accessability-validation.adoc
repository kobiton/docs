...
image::move-screen-closeup.png[width=1000,alt="A closeup to play next and previous screen button"]

=== Next and previous issue

Move through each issue on the current device screen. Each screen can contain multiple issues.

image::move-through-issues-closeup.png[width=400,alt="A closeup to play next and previous issues"]
...
image::issue description-context.png[width=1000,alt="A context to Accessibility Validation issue description"]
