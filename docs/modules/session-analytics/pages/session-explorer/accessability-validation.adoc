...
The Session Explorer automatically flags xref:_issue_types[accessibility issues] for each test session. Learn more about a specific issue by checking the xref:session-analytics:session-explorer/accessability-validation.adoc[issue details].
...
image:session-analytics:color-contrast-context.png[width=1000,alt="A context to color contrast cases"]
...
image:session-analytics:content-labeling-context.png[width=1000,alt="A context to Content Labeling cases on screen"]

== Issue details

image:session-analytics:yellow-dot-context.png[width=1000,alt="A context to yellow dots on the timeline and the screen"]
