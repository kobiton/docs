...
image:session-analytics:figma-project.png[width=1000, alt=""]

== Frames

All frames from the selected project.

image:session-analytics:frames-list.png[width=500, alt=""]

== Resolutions

Choose a resolution from the Figma project. By default, *All Resolutions* is selected.

image:session-analytics:all-resolutions.png[width=500, alt=""]

== Search bar

Filter the list of frames by a specific frame name.

image:session-analytics:search-frame.png[width=500, alt=""]

== Upload images

Upload an image to use to compare UI design.

image:session-analytics:upload-screen.png[width=500, alt=""]
