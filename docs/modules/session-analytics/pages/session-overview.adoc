...
[TIP]
Select *Create Jira Ticket* to keep track of issues you find.Learn more about our Jira integration xref:integrations:jira/enable-jira-integration.adoc[here].
