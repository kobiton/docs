...
In the xref:session-explorer/about-session-explorer.adoc[Session Explorer], leverage the NOVA AI engine to automatically flag accessibility issues, reinspect elements from the session, validate UI using Figma, and more.
