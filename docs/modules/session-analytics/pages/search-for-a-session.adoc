...
image:session-search-context.png[width=1000,alt="A context of Session page in Kobiton portal"]

[#_saved_searches]
== Saved searches

Run a previously-saved xref:session-analytics:custom-search-queries.adoc[custom search query].

image:session-analytics:saved-search-context.png[width=1000,alt="Choose saved search"]

== Date range

Display sessions within the selected date range.

image:session-analytics:date-range-context.png[width=1000, alt="Display sessions within the selected date range"]
...
image:session-analytics:session-tags-context.png[width=500,alt="Sessions with Failed tag"]
