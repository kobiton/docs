...
If your xref:integrations:jira/index.adoc[Jira integration is enabled], select xref:integrations:jira/create-a-jira-ticket.adoc[Jira ticket] to create a ticket that's linked to this session.
