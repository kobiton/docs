...
== Search for a test step

To search for a test step or issue, use the slider to zoom in and out of the timeline.

image:session-explorer:zoom.png[width=1000,alt="A closeup to Zoom function on the timeline"]

== View a test step

To view a test step, select it in the session timeline.
...
[NOTE]
Learn more about xref:session-explorer:validations/validate-accessability.adoc[accessibility validation].
