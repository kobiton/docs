...
To view an accessibility issue automatically flagged during your session, select a *green marker* in the timeline.

image:session-explorer-accessibility-validation.png[width=1000,alt="Yellow dots on the timeline showing Accessibility Validation"]
