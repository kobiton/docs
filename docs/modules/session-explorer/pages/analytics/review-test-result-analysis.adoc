...
* *Validation Type*: types of validation that were detected in the session:
...
* *Screens*: number of Test Steps (screens) that have at least one issue belonging to the validation type

* *Issues*: number of issues that occurred belonging to the validation type

* *View all*: hide or show all available or individual validation types on the session timeline
