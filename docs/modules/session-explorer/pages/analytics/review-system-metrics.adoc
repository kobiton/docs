...
image:session-explorer:cpu-closeup.png[width=500,alt="A closeup to CPU section of System Metrics"]
...
image:session-explorer:network-closeup.png[width=500,alt="A closeup to Network section of System Metrics"]
...
image:session-explorer:battery-closeup.png[width=500,alt="A closeup to Battery Drain section of System Metrics"]
...
image:system-metrics-temperature.png[width=500,alt="A closeup to Temperature section of System Metrics"]
