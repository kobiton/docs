...
:navtitle: Validate user accessibility

Learn how to validate user accessibility for your app or website so you can find and fix issues like touch target size, color contrast, and content labeling.
...
Select one of the *yellow dots* in the session timeline.
