...
image:yellow-dots-on-timeline-context.png[width=1000,alt="Click on a yellow dot in the timeline"]

Select *View Details*.

image:view-details-accessbility-validation-context.png[width=1000,alt="After click View Details, users are directed to Session Explorer window"]
