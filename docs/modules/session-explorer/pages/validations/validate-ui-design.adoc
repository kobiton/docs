...
You'll need to xref:integrations:figma/enable-figma-integration.adoc[connect your Figma to Kobiton] to use the full set of features. If you don't have a figma account, you can choose to xref:_use_an_image[upload an image to validate your UI instead].
