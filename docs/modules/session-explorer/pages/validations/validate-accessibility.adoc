...
[NOTE]
====
For Appium automation sessions, add both `kobiton:accessibilityValidation` and `kobiton:scriptlessCapture` to your script. See xref:automation-testing:scripting/add-accessibility-validation-to-appium-script.adoc[].
====
