...
image:change-your-profile-context.png[width=1000,alt="Drag and drop an image or select the pane to change your profile picture"]

=== Retrieve your username and email

The *Username* and *Email* fields are not editable. Use your username or email when authenticating with Kobiton.

image:profile:edit-name-section-closeup.png[width=500,alt="A closeup to username and email"]

[#_change_your_name]
=== Change your display name

To change your display name, select the *First name* and *Last name* fields and enter a name that's easy for others to identify. Your name will be displayed in your xref:session-explorer:search-for-a-session.adoc[sessions], xref:apps:app-metadata.adoc#_uploaded_by[apps], and xref:organization:teams/manage-teams.adoc[teams].

image:profile:edit-name-section-closeup.png[width=500,alt="A closeup to Change your name box"]

You can sign in to Kobiton Portal with this username or your email address.
For details, see xref:organization:sign-in-to-kobiton.adoc[].
...
[NOTE]
If you forgot your password, see xref:organization:sign-in-to-kobiton.adoc#_reset_your_password[Reset your password].
Email-based password reset is available on Cloud Portal only.
