...
[#_view_your_username_and_email]
=== View your username and email

You can view your username and email in the profile page.

NOTE: Username and email cannot be edited.
...
To change your display name, edit the *First name* and *Last name* fields then select *Update Profile*.
