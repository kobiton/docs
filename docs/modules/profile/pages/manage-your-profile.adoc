...
To change your display name, select the *First name* and *Last name* field and enter a name that's easy for others to identify. Your name will be displayed in your xref:session-explorer:search-for-a-session.adoc[sessions], xref:apps:app-metadata.adoc#_uploaded_by[apps], and xref:organization:teams/manage-teams.adoc[teams].
