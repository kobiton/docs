...
Enter a name that's easy for others to identify. This name will be displayed in your xref:session-analytics:search-for-a-session.adoc[sessions], xref:apps:app-metadata.adoc#_uploaded_by[apps], and xref:organization:manage-teams.adoc[teams].
