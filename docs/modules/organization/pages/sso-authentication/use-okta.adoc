...
image:organization:okta-general-settings.png[width=1000,alt="General Settings window"]
...
image:organization:okta-groups-attributes-context.png[width=1000,alt="Attribute statements showing email, firstName, lastName, phoneNumber, and memberOf mapped to Okta user and device values"]
