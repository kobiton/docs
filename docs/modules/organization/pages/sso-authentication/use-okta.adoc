...
image:add-application.png[width=1000,alt="Add Application"]
...
image:click-create.png[width=1000,alt="Click Create"]

In *General Settings*, enter a display name and add a logo to customize your sign-in portal, then select *Next*.

image:general-settings.png[width=1000,alt="General Settings window"]
...
image:download-okta-certificate.png[width=1000,alt="Select Okta Certificate"]
...
image:saml-config.png[width=1000,alt="SAML configuration window"]
