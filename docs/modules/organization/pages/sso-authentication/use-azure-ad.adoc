= Configure Kobiton Single Sign-on for Single sign-on with Microsoft Entra ID
:navtitle: Use Entra ID (formerly Azure AD)

In this article, you learn how to integrate Kobiton Single Sign-on with Microsoft Entra ID. When you integrate Kobiton Single Sign-on with Microsoft Entra ID, you can:

* Control in Microsoft Entra ID who has access to Kobiton Single Sign-on.
* Enable your users to be automatically signed-in to Kobiton Single Sign-on with their Microsoft Entra accounts.
...
Sign in to the Microsoft Entra admin center as at least a link:https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/permissions-reference#cloud-application-administrator[Cloud Application Administrator,window=read-later].
...
Now that your IdP application is initially created, you'll need to create Entra ID parameters mapped to Kobiton and download your Base64 certificate. Select *Set up single sign on* to get started.
