...
These are the predefined roles and the permissions for your organizaiton. You can also use these permissions when you xref:organization:roles/create-a-role.adoc[create a new role] or xref:roles/manage-roles.adoc#_set_permissions[change a role's permissions].
