...
:navtitle: User roles and permissions

These are the user roles and permissions available when xref:roles/create-a-role.adoc[creating] or xref:roles/manage-roles.adoc#_set_permissions[managing] user roles.

== Predefined roles

By default, the following roles are predefined in your organization.
