...
image:device-bundles-tab-context.png[width=1000,alt="Select Device Bundle tab in Org Management"]

Choose *iOS* or *Android*, then select *New Bundle*.

image:choose-os-closeup.png[width=1000,alt="Choose iOS or Android, then select New Bundle"]

Enter a name for your bundle.

image:type-bundle-name-closeup.png[width=400,alt="Type New Bundle name field"]

Manually search, or use the search bar to find devices.

image:search-device-closeup.png[width=500,alt="Manually search, or use the search bar to find devices"]

Select *Apply* to add a device to the bundle.

image:apply-devices-closeup.png[width=500,alt="Select Apply to add devices to a bundle"]

When you're finished, select *Save Bundle*.

image:save-bundle-context.png[width=1000,alt="click Save Bundle when already applied devices"]
