...
These are the roles and permissions available when xref:teams/manage-teams.adoc#_set_team_permissions[setting team permissions] or xref:organization:teams/change-a-users-team-role.adoc[changing a user's team role].
