...
[NOTE]
Only the current owner can transfer an organization. If the current owner no longer works at your company, mailto:support@kobiton.com[contact support].
...
image:organization:select-users-tab-context.png[width=1000,alt="select Users tab in Org Management"]
