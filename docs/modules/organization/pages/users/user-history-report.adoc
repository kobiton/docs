...
The user history report contains data about each user event. xref:organization:users/search-for-a-user.adoc[Choose a user], then select *User History* to get started.
