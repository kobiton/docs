...
image:select-org-management-context.png[width=1000,alt="Select the Org Management tab"]
...
image:sort-users-closeup.png[width=1000,alt="Select the up and down arrows to filter the list of users"]

Select their username.

image:select-users-closeup.png[width=1000,alt="A closeup to select their username"]
