...
[NOTE]
If your IdP sends these attributes under different names, you can map them instead of changing your IdP. See xref:organization:sso-authentication/configure-custom-attribute-mappings.adoc[].
