...
image:test-execution-plan.png[width=1000,alt="Click the Test Execution plan"]
...
image:data-driven-testing.png[width=500,alt="Dynamic Data Section"]

== Define a new dataset

Next to the “Manual” chipset, you will see the “+” icon for creating a new dataset for your revisit session.

image:define-new-dataset.png[width=500,alt="Click the + icon"]
...
image:set-new-value.png[width=500,alt="Edit the value"]
