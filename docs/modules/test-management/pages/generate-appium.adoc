...
image::genappium-location.png[width=700,alt="Generate Appoum script from Test Management screen"]
...
image::genappium-language.png[width=700,alt="Generate Appoum script to language and framework"]
