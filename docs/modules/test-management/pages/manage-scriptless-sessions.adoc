...
*View Test Case*.
+
image:view-test-case.png[width=1000,alt="Select View Test Case"]
...
image:run-scriptless.png[width=1000,alt="Run scriptless to start scriptless rerun sessions"]
...
image:export-appium.png[width=1000,alt="Export Appium script"]
