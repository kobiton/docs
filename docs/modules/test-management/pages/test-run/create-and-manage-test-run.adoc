...
image:test-management:test-run-review-test-run-new-test-run.PNG[width=700,alt="Selecting New Test Run by going to Test Management and then Test Runs"]

The *Test Run Setup* screen displays.

image:test-management:test-run-review-test-run-test-run-setup.PNG[width=700,alt="The Test Run Setup screen is displayed in Test Management section"]
...
image:test-management:test-run-review-test-run-test-case-or-test-suite.PNG[width=700,alt="Choose either Test Case or Test Suite"]
...
+
image:test-management:test-run-review-test-run-customize-test-case.PNG[width=300,alt="Select the specific version to run for the test case"]
...
+
image:test-management:test-run-review-test-run-customize-test-suite.PNG[width=700,alt="For the given Test Suite, select or deselect test cases and version that you want to run"]
...
image:test-management:test-run-review-test-run-application-versions.PNG[width=700,alt="Select the application version for the test suite or test case"]
...
* One device bundle,
+
image:test-management:test-run-review-test-run-device-bundle-or-individual-devices.PNG[width=700,alt="Device bubdle or individual devices selection options"]
+
...
+
image:test-management:test-run-review-test-run-list-individual-devices.PNG[width=700,alt="Dropdown list of individual devices for selection"]
+
...
image:test-management:test-run-review-test-run-customize-device-bundle.PNG[width=700,alt="Select the Customize option to choose the devices to run in the bundle"]

=== Device Allocation Strategy

Next, choose a *Device Allocation Strategy*. This only applies when running a test suite.

image:test-management:test-run-review-test-run-device-allocation-strategy.PNG[width=700,alt="When running a test suite, choose the Device Allocation Strategy"]

=== Execute the test run

After filling in all required fields, select *Run* to create and execute the test run.

image:test-management:test-run-review-test-run-execute-test-run.PNG[width=700,alt="Selecting the Run option to create and execute the test run"]

Once the test run is created, the success message appears with the option to *View Test Run*.

image:test-management:test-run-review-test-run-test-run-created-success-message.PNG[width=700,alt="Success message appears once the run is created"]
...
image:test-management:test-run-review-test-run-view-test-run.PNG[width=700,alt="Viewing the test run results"]
...
+
image:test-management:test-run-review-test-run-case-details.PNG[width=700,alt="Running is test case or test suite via the Test Case Details page"]
...
image:test-management:test-run-review-test-run-run-test-suite.PNG[width=700,alt="Creating a test run from a test suite"]
...
image:test-management:test-run-review-test-run-rerun-test-run.PNG[width=700,alt="Rerunning a test run via the Test Run Results page"]
...
image:test-management:test-run-review-test-run-manage-a-test-run.PNG[width=700,alt="Managing test runs via the Test Run page"]
