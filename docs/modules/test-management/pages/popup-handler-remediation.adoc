...
[NOTE]
====
If the blocker is not caused by a pop-up, use the **Element Selection** tab for standard remediation. For more information see xref:test-management:remediations.adoc[].
====