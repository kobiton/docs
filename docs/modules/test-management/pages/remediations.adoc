...
From Session Explorer, users can review the captured baseline step alongside the execution attempt and select the correct UI element when a mismatch occurs.
