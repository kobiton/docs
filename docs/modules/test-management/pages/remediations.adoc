...
+
Matched text is highlighted on the screenshot. If no match is found, an error appears. Adjust the hint text and try again.
...
The pop-up is marked as optional, and subsequent revisits dismiss it using the element you selected.

[NOTE]
====
If the blocker is not caused by a pop-up, use the *Element Selection* tab for standard remediation. For more information, see <<_submit_a_remediation,Submit a remediation>>.
====
