...
== Auto-upgrade deviceConnect: force offline devices if deviceConnect is 2 major versions behind the latest
...
[WARNING]
There is a known issue that if a new hosting machine with deviceConnect v4.12 or below is added to an organization , the hosting machine and all its devices are not displayed in the Device Management page in the portal. Therefore, make sure you *install deviceConnect v4.13 or later* to new hosting machines.
