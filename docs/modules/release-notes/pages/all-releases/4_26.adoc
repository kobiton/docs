...
See the image injection documentation for setup instructions and usage guide. [xref:modules:manual-testing/test-your-app-camera.adoc]
...
See the Kobiton MCP server documentation for available skills and setup guidance. [xref:modules:ai/pages/mcp]
