...
- Camera v1 and Camera Intent API is not supported in the xref:apps:image-injection-sdk/add-the-sdk-to-your-android-app.adoc[Kobiton image injection SDK,window=read-later].
...
- API key authentication for virtualUSB and the virtualUSB CLI
