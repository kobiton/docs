...
:navtitle: Kobiton 4.23S release notes
...
== Scheduled export of Usage Report in Standalone environments

The Standalone Portal now automatically exports the Usage Report in Predefined Reports as a `.csv` file every quarter. The exported file is saved on the Dell server at: `/home/kobitonSupport/kobiton-reports/output/quarterly/`
...
* Replaced the "Screenshot is not available" picture with the appropriate messages below for test steps that have no screenshot:
...
* *Basic Appium 2:* Updated Basic Appium server to `2.19.0`
