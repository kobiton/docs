...
The Standalone Portal now automatically exports the Usage Report in Predefined Reports into a `.csv` file every quarter and put it in the location `/home/kobitonSupport/kobiton-reports/output/quarterly/` on the Dell server.
