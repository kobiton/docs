...
See xref:automation-testing:basic-appium-server/install-appium-gesture-plugin.adoc[this guide] on how to install the plugin for Customer-hosted and Standalone deployments.
