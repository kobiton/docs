...
[NOTE]
====
* To connect iOS devices to virtualUSB for Windows, install a compatible version of iTunes for Windows first before installing virtualUSB.
