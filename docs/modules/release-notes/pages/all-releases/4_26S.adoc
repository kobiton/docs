...
https://docs.kobiton.com/ai/mcp/claude-code[Get started with Kobiton's Claude Code plugin,window=read-later]
...
See the xref:ai:mcp/index.adoc[Kobiton MCP server documentation,window=read-later] for available skills and setup guidance.
...
* *Turbo Test Execution:* Reduced test execution latency by eliminating repeated artifact downloads through local caching.
* *UI updates:*
...
*** Your last selected Device List tab is preserved when you navigate away and return.
