= Kobiton 4.26S Release Notes
:page-aliases: release-notes:all-releases:4_26_5S.adoc

:navtitle: Kobiton 4.26S release notes
...
== Kobiton plugin for AI Coding Agents

Kobiton now integrates directly with well-known AI Coding Agents, enabling AI-driven mobile test automation on real devices without leaving the AI workspace.

The list of supported AI Coding Agents are: Claude Code, Gemini, Copilot, and Codex.

With the Kobiton plugin, developers and testers can use natural language to upload apps, manage devices, execute Appium tests, and review results — all within the AI Coding Agents' command-line interface (CLI). This keeps test creation, execution, and validation in a single continuous workflow.

*Key capabilities*

* Upload and install mobile apps directly from AI Coding Agents CLI.
...
Kobiton plugin for AI Coding Agents is available to users with active Kobiton and Agents subscriptions.

Refer to the below instructions to use the plugin with Standalone:

* xref:ai:mcp/claude-code.adoc[Claude Code,window=read-later]
* xref:ai:mcp/install-local-ai-plugin.adoc["Gemini, Copilot, and Codex",window=read-later]
...
- Automatic browser-based authentication flow in AI Coding Agents
