...
When the below notification banner appears in the Portal, a deviceConnect update is available for at least 1 Mac mini host in your organisation:

image:new-version-available.png[width=1000,alt="The banner about new version of deviceConnect"]

To update deviceConnect remotely, log into the Kobiton Portal with an administrator account.
...
Log into the Kobiton Portal with an administrator account.
