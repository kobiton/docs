...
In Samsung devices running One UI 6.0 (Android 14) and later:
...
* The *Auto Blocker* feature will prevent Kobiton mobile agent from controlling the device.

Both these features can make devices offline.
...
image:device-lab-management:andrord-prepare-security-privacy-details.png[width=240, alt="The Auto Blocker security feature is disabled in the Security and Privacy settings on Android."]
