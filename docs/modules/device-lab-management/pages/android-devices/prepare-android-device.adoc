...
In **Developer options**, turn off the system optimization setting. Its name and location depend on the version of the operating system:

* On **MIUI**, disable **MIUI Optimization**.

* On **HyperOS**, go to **Settings** > **Additional settings** > **Developer options** and turn off **Turn on system optimization**. Select **Accept** to confirm.
