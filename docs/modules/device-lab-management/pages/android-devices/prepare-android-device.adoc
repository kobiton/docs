...
In **Developer options**, turn off system optimization. If you do not see the setting, tap the **Reset to default values** field repeatedly until it appears; the number of taps varies by model.
