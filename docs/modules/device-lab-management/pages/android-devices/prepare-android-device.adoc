...
image:device-lab-management:andrord-prepare-security-privacy-details.png[width=240, alt=""]

Select *More security settings*, then turn off *Block USB connections while locked*.

image:device-lab-management:android-prepare-more-security-settings.png[width=240, alt=""]
