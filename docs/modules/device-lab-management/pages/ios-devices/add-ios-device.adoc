...
* Export the appropriate xref:ios-devices/generate-an-ios-signing-certificate.adoc[developer certificates](`.p12`) and xref:ios-devices/generate-an-ios-provisioning-profile.adoc[provisioning profiles](`.mobileprovision`) for the UDID of the device.
