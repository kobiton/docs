...
Follow xref:ios-devices/import-ios-signing-certificates-and-provisioning-profiles.adoc[this section,window=read-later] to import certificates and provisioning profiles to the Mac mini host.
