...
If you see the *deviceControl* warning or the error under the device's name with either of the below messages, follow this section to troubleshoot the issue and generate and/or import the correct certificates and provisioning profiles.
