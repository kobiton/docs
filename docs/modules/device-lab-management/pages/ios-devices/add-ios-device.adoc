...
Tap Trust in the *Trust this computer* popup on the iOS device. The *Trust this computer* prompts will reappear, tap *Trust* again. After this, there should be no more *Trust* prompts.
