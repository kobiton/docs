...
The Bringing Devices Together (introduced with iOS 17) blocks the device from functioning normally in a manual session.
...
image:device-lab-management:ios-prepare-general-airdrop.png[width=240,alt=""] -> image:device-lab-management:ios-prepare-airdrop-bring-devices-together-off.png[width=240,alt=""]
