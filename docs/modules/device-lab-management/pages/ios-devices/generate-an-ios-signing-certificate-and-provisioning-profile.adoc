...
* Ensure that the enrolled account has 1 available Apple Development or iOS App Development certificate slot, as the total number of slots are limited. See link:https://help.apple.com/xcode/mac/current/#/dev3a05256b8[this article] for more details.
...
At the Apple Developer https://developer.apple.com/account/resources/[resources] page, select *Profiles*.

image:device-lab-management:ios-signing-certificate-select-generate-a-profile-closeup.png[]
