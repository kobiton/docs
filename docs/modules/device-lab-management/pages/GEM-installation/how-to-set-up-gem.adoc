...
5. When the set up is done, shutdown the Dell server.

== Install the GEM into the Dell server

Create a GEM bootable USB stick, see xref:GEM-installation/make-a-gem-bootable.adoc[Process to make a GEM-bootable USB stick].

include::device-lab-management:GEM-installation/make-a-gem-bootable.adoc[leveloffset=2,indent=0]

Follow xref:GEM-installation/how-to-set-up-gem-in-dell-server.adoc[How to setup GEM in a blank Dell server i.e. no existing OS in the disk drive]

include::device-lab-management:GEM-installation/how-to-set-up-gem-in-dell-server.adoc[leveloffset=2,linesindent=0]

3.3. Follow the section Server Configuration in Gigacap Server Build.

include::device-lab-management:GEM-installation/make-a-gem-bootable.adoc[leveloffset=2,lines=1]

include::device-lab-management:GEM-installation/make-a-gem-bootable.adoc[leveloffset=2,lines=5..120]
