...
System Metrics shows Temperature of the device to help users check the device's temperature. Thus, they can prevent overheating before it becomes a problems.

Users can see Temperature in the interface of ongoing Manual sessions.

NOTE: Currently,this feature is only available on Android devices and Kobiton v4.2.

== Navigate to Temperature

From the *Device list*, click Android button to filter Android devices.

image::device list.png[1000,1000]

Click *Launch* under an Android device.

image::launch android device.png[1000,1000]
...
image::temperature.png[1000,1000]
...
image::ios device.png[1000,1000]
