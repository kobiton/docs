...
include::partial$supported-filetypes.adoc[]
...
[NOTE]
You can find which team(s) you're a part of on your xref:organization:your-teams/manage-your-teams.adoc[organization's team page].
