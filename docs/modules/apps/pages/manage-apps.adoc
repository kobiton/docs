...
Learn how to manage apps in the app repository so you and your team can install apps xref:devices:install-an-app.adoc[before] or xref:manual-testing:install-an-app.adoc[during] test sessions. Select *Apps* to get started.

image:apps:apps-context.png[width=, alt=""]
...
[NOTE]
Users can find which team(s) you're a part of on your xref:organization:teams/manage-teams.adoc[organization's team page].
