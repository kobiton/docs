...
Learn how to manage apps in the app repository so you and your team can install apps xref:devices:install-an-app.adoc[before] or xref:manual-testing:install-an-app.adoc[during] test sessions.
