...
Learn how to add our biometric authentication library to your Android xref:apps:enable-biometric-authentication/add-our-library-to-your-ios-app.adoc[or iOS] app so you can test biometric authentication during your manual and automated test sessions.
