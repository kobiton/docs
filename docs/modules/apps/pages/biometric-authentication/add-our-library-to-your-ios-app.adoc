...
Learn how to add our biometric authentication library to your iOS xref:apps:biometric-authentication/add-our-library-to-your-android-app.adoc[or Android] app so you can test biometric authentication during your manual and automated test sessions.
