...
[source,shell]
----
curl -X POST https://api.kobiton.com/v2/apps/uploadUrl \
...
* `${generatedUrl}`: the `url` obtained from the xref:_generate_an_upload_url[previous section]. Use the exact full URL.
