...
[NOTE]
If you receive `error 404` with the message `App version ID ... doesn't exist`, the application version might be made accessible to your account. Contact an admin for access.