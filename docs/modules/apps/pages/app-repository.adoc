...
image::apps:apps-context1.png[width=1000,alt="A context to the plus icon to upload the app"]
...
image::apps:rename-an-app.png[width=1000,alt="A closeup to Rename an app"]
...
image::apps:apps-closeup.png[width=300,alt=" A closeup to Remove App"]

To remove a specific version, select the app first and select a version to remove instead.

image::apps:remove-a-version-of-the-app.png[width=1000,alt="A closeup to remove a version of the app"]

== Download an app version

Select *Download* to download the the current app version to your computer.

image::apps:apps-closeup1.png[width=300,alt="A closeup to Download the current app"]

To download a specific version, select the app first and select a version to download instead.

image::apps:download-another-version-of-the-app.png[width=1000,alt="A closeup to Download a version of the app"]
...
image::apps:apps-closeup2.png[width=300,alt="A closeup to access Limit access of the app"]
