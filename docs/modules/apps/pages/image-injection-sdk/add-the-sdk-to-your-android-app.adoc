= Add image injection SDK to Android app
:navtitle: Add the image injection SDK to Android app

Implement Kobiton’s custom SDK within an Android application to enable image injection.

NOTE: For supported Android applications, image injection can now be enabled through automatic instrumentation without requiring the Kobiton SDK. Use this SDK integration method only when instrumentation is not suitable for your application.
