...
For a complete reference of available Claude Code plugins, commands, agents, and skills, see the xref:mcp/claude-plugin-ref.adoc[Claude Code plugin reference].
