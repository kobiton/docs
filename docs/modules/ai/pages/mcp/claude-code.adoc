...
1. Open Claude Code and create or select a folder when prompted
2. Run:
[source,bash]
----
...
If the command runs successfully, Claude Code will prompt you to sign in and begin interacting with Kobiton.
